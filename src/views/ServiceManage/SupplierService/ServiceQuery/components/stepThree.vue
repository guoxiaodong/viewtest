...
<template>
    <div class="serviceQuery-stepOne">
        ...
        <Steps :current="2">
            ...
            <div class="innerbtns" style="top:0px">
                <Row>
            ...
            <div slot="footer">
                ...
                <Button type="primary" @click="nextStep()" style="margin-left: 150px">下一步</Button>
            </div>
 <!--增加等级指标-->
        <Modal
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            nextStep () {
                this.$emit('show', 4, this.id)
            },
            cancelStep () {
                this.$emit('show', 2, this.id)
            }
        },
        watch: {
            addLevelsItem (v) {
