<style>
.serviceQuery-stepFinish .finish{
}
.serviceQuery-stepFinish .finish div{
    width:fit-content;
...
.serviceQuery-stepFinish .finish .button{
    margin-left: 96px;
    margin-right: 10px;
}
.serviceQuery-stepFinish .finish img{
    margin-left: 121px;
    margin-bottom: 10px;
    width: 120px;
    height: 120px;
...
<template>
    <div class="serviceQuery-stepFinish">
