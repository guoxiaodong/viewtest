    ...
    <div class="serviceQuery-stepOne">
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="150" style="margin:25px 0 0 15px;padding-left: 16%;width: 650px" >
                ...
                <FormItem prop="images" label="上传图片" style="width: 100%">
                    ...
                    <Modal title="View Image" v-model="visible" class="picView modalTop">
                ...
                <FormItem label="所属财务科目：" prop="finClass">
                    <Select v-model="formValidate.finClass" placeholder="请选择所属财务科目" filterable >
                ...
                <FormItem label="管理对象：" prop="manObject">
                    <Select v-model="formValidate.manObject"  multiple  filterable>
                ...
                <FormItem label="所属行政服务：" prop="interClass">
                    <Select v-model="formValidate.interClass"  multiple  filterable>
            ...
            openEdit () {
                ...
                ServiceHttp.supplierDetail(data).then((data) => {
                    ...
                    for (var a in this.data) {
                        for (var b in this.data[a].children) {
                            if (this.data[a].children[b].value == data[0].type_id) {
                                this.formValidate.type = [this.data[a].value, data[0].type_id]
                            }
                        }
                    }
                    if (data[0].objects) {
                    ...
                    if (data[0].images && data[0].images.length != 0) {
                        var pic = {
                            name: data[0].images[0].name,
                            url: data[0].images[0].url
                        }
                        this.defaultList.push(pic)
                    }
                    ...
                    this.formValidate.finClass = data[0].finance_id
                    this.formValidate.containIntro = data[0].intro_services
                    this.formValidate.rangeIntro = data[0].intro_sites
                    this.checkdata = this.formValidate
                })
            }
        },
